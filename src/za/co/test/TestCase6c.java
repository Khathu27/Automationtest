	...
	public static void main(String[] args) throws InterruptedException {
	    ...
	    //System.setProperty("webdriver.chrome.driver", "C:/Program Files (x86)/Google/Chrome/Application/chrome.exe"); 
		 ...
		 driver.get(url);
		    ...
		    WebElement subLink = driver.findElement(By.cssSelector("a[href='" +url+ "/About/contact-us']"));
		    subLink.click();
		    
		    String exp_title = "Contact Us";
		    String curr_window_title = subLink.getTagName();
	        /* Hard Assert */
	      if (curr_window_title.equals(exp_title)) {
